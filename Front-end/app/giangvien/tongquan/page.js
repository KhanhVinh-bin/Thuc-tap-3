        ...
        <main className="gv-main">
          ...
          <section className="gv-top-grid">
            <div className="gv-card gv-revenue">
              ...
              <div className="gv-area-chart blue" aria-hidden="true"><ChartAreaIcon color="blue" /></div>
            ...
            <div className="gv-card gv-complete">
              ...
              <div className="gv-area-chart red" aria-hidden="true"><ChartAreaIcon color="red" /></div>
          ...
          <section className="gv-mid-grid">
            <div className="gv-card">
              ...
              <div className="gv-sparkline" aria-hidden="true"><ChartSparklineIcon color="green" /></div>
