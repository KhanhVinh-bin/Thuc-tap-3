...
export default function GiangVienDoanhThuPage() {
  ...
  const months = [
    { label: "T5/24", value: 9000 },
    { label: "T6/24", value: 5000 },
    { label: "T7/24", value: 12000 },
    { label: "T8/24", value: 5000 },
    { label: "T9/24", value: 10000 },
    { label: "T10/24", value: 11000 },
  ]
        ...
        <main className="gvr-main">
          ...
          <section className="gvr-top-cards">
            <div className="gvr-card green">
              ...
              <div className="gvr-card-value">84.3M VND</div>
              <div className="gvr-card-sub">↑ +4% So với tháng trước</div>
            </div>
            ...
            <div className="gvr-card blue">
              ...
              <div className="gvr-card-value">8.3M VND</div>
            ...
            <div className="gvr-card purple">
              ...
              <div className="gvr-card-value">13.3M VND</div>
              <div className="gvr-card-sub">103 khóa học đã được bán</div>
            </div>
          </section>

          {/* Chart */}
          <section className="gvr-chart">
            <div className="gvr-chart-title">Biểu đồ doanh thu</div>
            <div className="gvr-chart-area">
              <div className="gvr-bars">
                {months.map((m) => {
                  const h = Math.round((m.value / max) * 220)
                  return (
                    <div key={m.label} className="gvr-bar">
