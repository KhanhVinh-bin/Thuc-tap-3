  ...
  const students = [
    {
      ...
      registeredAt: "Đăng ký: 15/08/2024",
      progressPercent: 85,
      progressText: "34/40 bài",
      lastAccess: "3 giờ trước",
      status: { label: "Đang học", type: "learning" },
    },
    {
      name: "Nguyễn Văn A",
      email: "a@gmail.com",
      ...
      registeredAt: "Đăng ký: 15/08/2024",
      progressPercent: 15,
      progressText: "13/40 bài",
      lastAccess: "3 giờ trước",
      status: { label: "Không hoạt động", type: "inactive" },
    },
    {
      name: "Nguyễn Văn A",
      email: "a@gmail.com",
      ...
      registeredAt: "Đăng ký: 15/08/2024",
      progressPercent: 67,
      progressText: "28/40 bài",
      lastAccess: "3 giờ trước",
      status: { label: "Hoạt động", type: "active" },
    },
    {
      name: "Nguyễn Văn A",
      email: "a@gmail.com",
      ...
      <div className="gv-dashboard">
        ...
        <main className="gv-content">
          <div className="gvs-card">
            <div className="gvs-card-header">
              <div>
                <div className="gvs-title">Học viên</div>
                <div className="gvs-sub">Danh sách học viên</div>
              </div>
            </div>
                ...
                <div key={i} className="gvs-row">
                  <div className="gvs-student">
                    ...
                    <div className="gvs-student-info">
                      <div className="gvs-student-name">{s.name}</div>
                      <div className="gvs-student-email">{s.email}</div>
                    </div>
                  </div>
                  <div className="gvs-course">
                    <div className="gvs-course-title">{s.course}</div>
                    <div className="gvs-course-date">{s.registeredAt}</div>
                  </div>
                  <div className="gvs-progress">
                    <div className="gvs-progress-top">
                      <span className="gvs-progress-percent">{s.progressPercent}%</span>
                      <span className="gvs-progress-text">{s.progressText}</span>
                    </div>
                    <div className="gvs-progress-bar">
                      <div className="gvs-progress-fill" style={{ width: `${s.progressPercent}%` }} />
                    </div>
                  </div>
                  <div className="gvs-access">{s.lastAccess}</div>
                  <div className="gvs-status">
                    <span className={`gvs-pill ${s.status.type}`}>{s.status.label}</span>
                  </div>
                </div>
              ))}
            </div>
