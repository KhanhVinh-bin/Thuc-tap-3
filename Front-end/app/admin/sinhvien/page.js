...
const handleToggleLockAccount = async (studentId) => {
  ...
  const handleAddStudent = async () => {
    // Tạm thời hiển thị thông báo; cập nhật route khi có trang tạo sinh viên
    const Swal = (await import('sweetalert2')).default;
    await Swal.fire({
      title: 'Chức năng đang phát triển',
      text: 'Trang thêm mới sinh viên sẽ được bổ sung.',
      icon: 'info'
    });
    // Nếu đã có trang tạo sinh viên, có thể dùng:
    // router.push('/admin/sinhvien/tao');
  };
