...
export default function InstructorManagement() {
  ...
  // Thêm: xuất CSV danh sách giảng viên
  const handleExportCSV = () => {
    const rows = [
      ['MaGV', 'Ten', 'Email', 'NgayTao', 'ChuyenMon', 'SoKhoaHoc', 'TrangThai'],
      ...instructors.map(i => [
        i.idDisplay,
        i.name,
        i.email,
    ...
    a.href = url;
    a.download = `Danh-sach-giang-vien.csv`;
    a.click();
      ...
      <div className="page-header">
        ...
        <div className="header-right">
          <button className="btn-export" onClick={handleExportCSV}>
            <Download size={16} className="btn-icon" /> Xuất CSV
          </button>
