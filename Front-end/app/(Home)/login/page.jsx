...
export default function LoginPage() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      login(
        {
          id: result.userId, // id chung
          userId: result.userId, // để tương thích với các component khác
          name: result.fullName || result.name || "Người dùng",
          email: result.email,
          role: result.roles?.[0] || (userType === "student" ? "student" : "instructor"),
        },
        result.token || null
      );
      ...
      const firstRole = result.roles?.[0] || "student";
      if (userType === "instructor" || firstRole === "instructor") {
